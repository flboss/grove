...
use crate::ast::{
    BuiltinType, ColumnMapping, ConfigBlock, DecArithmetic, Field as FieldDecl, FkMapping,
    IntArithmetic, ListStorage, RelationArrow, Schema, TypeExpr,
};
use crate::validated::{
    Column, ColumnId, Config, Field, FieldId, Relation, Root, ScalarType, StorageTable, Struct,
    StructId, Table, TableId, ValidatedSchema, ValueType,
};
...
mod tests {
    ...
    use crate::validated::{DecArithmetic, IntArithmetic};
